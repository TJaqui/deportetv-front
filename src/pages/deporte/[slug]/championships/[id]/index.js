...
export async function getServerSideProps({params}){
  ...
  const url = `https://livescore-api.com/api-client/scores/history.json?key=W8TPhcJoRlIJMdLT&secret=vik7dkDKOq1Q7TU41OTj0CIRYqBLDmF9&competition_id=${params.id}&page=2`
